...
WHERE
  projects.import_type = 'bitbucket_server' AND projects.created_at BETWEEN '2020-11-17 19:22:32.723497' AND '2020-12-15 19:22:32.723560' AND projects.import_type IS NOT NULL
GROUP BY 1
