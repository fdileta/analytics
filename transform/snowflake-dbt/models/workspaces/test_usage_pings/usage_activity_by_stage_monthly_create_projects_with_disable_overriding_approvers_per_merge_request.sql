...
WHERE
    gitlab_dotcom_projects_dedupe_source.created_at BETWEEN '2020-11-17 19:22:32.723497' AND '2020-12-15 19:22:32.723560' AND gitlab_dotcom_projects_dedupe_source.disable_overriding_approvers_per_merge_request = TRUE
