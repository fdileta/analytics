...
{% docs fct_usage_metrics_sales_fy21_q1_by_instance_user_count %}

This is a fact data model that representing the usage metrics requested by the sales team, where we select the usage ping for that month based on the max instance_user_count. 
...
{% docs fct_usage_metrics_sales_fy21_q1_by_latest %}

This is a fact data model that representing the usage metrics requested by the sales team, where we select the usage ping for that month based on the last usage ping in that month. 
...
{% docs fct_usage_metrics_sales_fy21_q1_by_umau %}

This is a fact data model that representing the usage metrics requested by the sales team, where we select the usage ping for that month based on the max umau 28 day counter value. 
