with fct_mrr_totals_levelled AS (
       ...
       FROM retention_subs
        ...
        SELECT finals.dim_crm_account_id,
               ...
               datediff(month, crm_account_cohort_month, original_mrr_month) as months_since_crm_account_cohort_start,
               datediff(quarter, crm_account_cohort_quarter, original_mrr_month) as quarters_since_crm_account_cohort_start,
