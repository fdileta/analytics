WITH dim_billing_accounts AS (
    ...
    LEFT JOIN days_between_arr
      ON monthly_arr_parent_level.ultimate_parent_account_id = days_between_arr.ultimate_parent_account_id AND monthly_arr_parent_level.arr_month = days_between_arr.arr_month
